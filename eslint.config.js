...
export default tseslint.config(
  ...
  {
    // Fast Refresh does not apply to these: `src/components/ui` is generated by the
    // shadcn CLI (it exports variant helpers next to components by design, and is not
    // hand-edited), and `.design-sync/entry.tsx` is a bundle entry that re-exports it.
    files: ["src/components/ui/**/*.tsx", ".design-sync/**/*.tsx"],
    rules: {
