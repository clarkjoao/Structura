...
const specs = {
  S400: { id: "audit-S400", name: "SWEEP-400", nodeCount: 400, edgeCount: 520, panelSpec: [4, 8], mixed: true, waypointRatio: 0.2 },
  S600: { id: "audit-S600", name: "SWEEP-600", nodeCount: 600, edgeCount: 780, panelSpec: [4, 8], mixed: true, waypointRatio: 0.2 },
  S800: { id: "audit-S800", name: "SWEEP-800", nodeCount: 800, edgeCount: 1040, panelSpec: [4, 8], mixed: true, waypointRatio: 0.2 },
  S1000: { id: "audit-S1000", name: "SWEEP-1000", nodeCount: 1000, edgeCount: 1300, panelSpec: [4, 8], mixed: true, waypointRatio: 0.2 },
};
...
writeFileSync(join(outDir, "seed-sweep.json"), JSON.stringify(report, null, 2));
