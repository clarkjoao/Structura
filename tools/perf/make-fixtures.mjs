...
const specs = {
  P: { id: "audit-P", name: "AUDIT-P (20n/25e)", nodeCount: 20, edgeCount: 25, panelSpec: [1], mixed: false, waypointRatio: 0 },
  M: { id: "audit-M", name: "AUDIT-M (100n/130e)", nodeCount: 100, edgeCount: 130, panelSpec: [2, 4], mixed: false, waypointRatio: 0.25 },
  G: { id: "audit-G", name: "AUDIT-G (400n/550e)", nodeCount: 400, edgeCount: 550, panelSpec: [3, 6, 9], mixed: true, waypointRatio: 0.2 },
  XG: { id: "audit-XG", name: "AUDIT-XG (5000n/6500e)", nodeCount: 5000, edgeCount: 6500, panelSpec: [5, 12, 30], mixed: true, waypointRatio: 0.2 },
};
...
writeFileSync(join(outDir, "seed.json"), JSON.stringify(report, null, 2));
