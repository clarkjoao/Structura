  ...
  function buildDiagrams(): Record<string, Diagram> {
    return {
      ...
      "d-us-context": {
        ...
        activeSceneId: null,
        nodeLayouts: {
          // Leitura esq→dir: Atores → Sistema → Sistemas externos → Nota
          "us-ctx-creator":   { elementId: "us-ctx-creator",   x: 80,   y: 200 },
          "us-ctx-visitor":   { elementId: "us-ctx-visitor",   x: 80,   y: 480 },
          "us-ctx-system":    { elementId: "us-ctx-system",    x: 480,  y: 300, width: 220, height: 120 },
          "us-ctx-auth0":     { elementId: "us-ctx-auth0",     x: 900,  y: 120 },
          "us-ctx-sendgrid":  { elementId: "us-ctx-sendgrid",  x: 900,  y: 320 },
          "us-ctx-maxmind":   { elementId: "us-ctx-maxmind",   x: 900,  y: 500 },
          "us-ctx-note":      { elementId: "us-ctx-note",      x: 1160, y: 60,  width: 360, height: 560 },
        },
        snapshot: {
          iconLibrary: {},
          flows: {
      ...
      "d-us-containers": {
        ...
        viewport: { x: 0, y: 0, zoom: 0.80 },
        edgeLayouts: [],
        scenes: {},
        activeSceneId: null,
        nodeLayouts: {
          // Leitura esq→dir, duas trilhas:
          // Trilha alta: Creator(60) → SPA(360) → MgmtAPI(660) → Queue(980)
          // Trilha baixa: Visitor(60) → RedirAPI(660) → Cache(660) → DB(980) → Worker(980)
          "us-ct-creator":    { elementId: "us-ct-creator",    x: 60,   y: 200 },
          "us-ct-visitor":    { elementId: "us-ct-visitor",    x: 60,   y: 520 },
          "us-ct-boundary":   { elementId: "us-ct-boundary",   x: 280,  y: 80,  width: 960, height: 760 },
          "us-ct-spa":        { elementId: "us-ct-spa",        x: 360,  y: 160, width: 200, height: 100 },
          "us-ct-mgmt-api":   { elementId: "us-ct-mgmt-api",   x: 660,  y: 160, width: 220, height: 100 },
          "us-ct-queue":      { elementId: "us-ct-queue",      x: 980,  y: 160, width: 200, height: 100 },
          "us-ct-redir-api":  { elementId: "us-ct-redir-api",  x: 660,  y: 480, width: 220, height: 100 },
          "us-ct-cache":      { elementId: "us-ct-cache",      x: 660,  y: 660, width: 200, height: 100 },
          "us-ct-db":         { elementId: "us-ct-db",         x: 980,  y: 480, width: 200, height: 100 },
          "us-ct-worker":     { elementId: "us-ct-worker",     x: 980,  y: 660, width: 200, height: 100 },
          "us-ct-note":       { elementId: "us-ct-note",       x: 1300, y: 80,  width: 340, height: 420 },
        },
        snapshot: {
          iconLibrary: {},
          flows: {
      ...
      "d-us-components": {
        ...
        activeSceneId: null,
        nodeLayouts: {
          // 3 swimlanes horizontais, leitura esq→dir dentro de cada camada:
          // HTTP:  api-group (endpoints) ─→ auth-guard
          // APP:   url-svc ─→ analytics-svc ─→ cache-svc ─→ event-pub
          // INFRA: db-urls ─→ db-clicks ─→ json-req ─→ json-res
  
          // Swimlane containers (largura total 1400)
          "us-cp-lane-http":    { elementId: "us-cp-lane-http",    x: 40,   y: 40,   width: 1420, height: 240 },
          "us-cp-lane-app":     { elementId: "us-cp-lane-app",     x: 40,   y: 300,  width: 1420, height: 180 },
          "us-cp-lane-infra":   { elementId: "us-cp-lane-infra",   x: 40,   y: 500,  width: 1420, height: 260 },
  
          // HTTP layer: api-group com todos os endpoints à esquerda, auth-guard à direita
          "us-cp-api-group":    { elementId: "us-cp-api-group",    x: 80,   y: 60,   width: 320,  height: 220 },
          "us-cp-ep-post":      { elementId: "us-cp-ep-post",      x: 80,   y: 60   },
          "us-cp-ep-get":       { elementId: "us-cp-ep-get",       x: 80,   y: 100  },
          "us-cp-ep-patch":     { elementId: "us-cp-ep-patch",     x: 80,   y: 140  },
          "us-cp-ep-delete":    { elementId: "us-cp-ep-delete",    x: 80,   y: 180  },
          "us-cp-ep-analytics": { elementId: "us-cp-ep-analytics", x: 80,   y: 220  },
          "us-cp-auth-guard":   { elementId: "us-cp-auth-guard",   x: 560,  y: 110  },
  
          // App layer: serviços alinhados às colunas dos endpoints acima
          "us-cp-url-svc":       { elementId: "us-cp-url-svc",       x: 140,  y: 350  },
          "us-cp-analytics-svc": { elementId: "us-cp-analytics-svc", x: 460,  y: 350  },
          "us-cp-cache-svc":     { elementId: "us-cp-cache-svc",     x: 780,  y: 350  },
          "us-cp-event-pub":     { elementId: "us-cp-event-pub",     x: 1100, y: 350  },
  
          // Infra layer: db-tables e json-viewers alinhados às colunas acima
          "us-cp-db-table-urls":   { elementId: "us-cp-db-table-urls",   x: 80,   y: 530, width: 300, height: 200 },
          "us-cp-db-table-clicks": { elementId: "us-cp-db-table-clicks", x: 440,  y: 530, width: 300, height: 200 },
          "us-cp-json-create-req": { elementId: "us-cp-json-create-req", x: 780,  y: 530, width: 280, height: 180 },
          "us-cp-json-create-res": { elementId: "us-cp-json-create-res", x: 1100, y: 530, width: 280, height: 180 },
        },
        snapshot: {
          iconLibrary: {},
          flows: {
      ...
      "d-us-deployment": {
        ...
        scenes: {
          "scene-tobe-geodeploy": {
            ...
            nodeLayouts: {
              // Lambda@Edge fica entre CloudFront (x=290) e ALB (x=520) — intercepta requests
              "dp-lambda-edge": { elementId: "dp-lambda-edge", x: 400,  y: 360  },
              "dp-note-tobe":   { elementId: "dp-note-tobe",   x: 1680, y: 700, width: 360, height: 360 },
            },
          },
        },
        nodeLayouts: {
          // Leitura esq→dir: Route53 → [CloudFront/WAF + S3] → ALB → ECS cluster → RDS/Cache
          // SQS/CloudWatch/Secrets ficam na coluna direita (serviços gerenciados)
          // Notas ficam além da borda direita da região
  
          // Região e VPC — containers principais
          "dp-region":          { elementId: "dp-region",          x: 160,  y: 40,   width: 1440, height: 1020 },
          "dp-vpc":             { elementId: "dp-vpc",             x: 200,  y: 120,  width: 1360, height: 880  },
  
          // Route53 — à esquerda da VPC (entrada do DNS)
          "dp-route53":         { elementId: "dp-route53",         x: 60,   y: 460  },
  
          // Subnet pública — lado esquerdo da VPC
          // Coluna 1: CloudFront + WAF (borda da internet)
          // Coluna 2: S3 (estático) + ALB (proxy)
          "dp-public-subnet":   { elementId: "dp-public-subnet",   x: 240,  y: 180,  width: 520,  height: 440 },
          "dp-cloudfront":      { elementId: "dp-cloudfront",      x: 290,  y: 260  },
          "dp-waf":             { elementId: "dp-waf",             x: 290,  y: 460  },
          "dp-s3-spa":          { elementId: "dp-s3-spa",          x: 520,  y: 260  },
          "dp-alb":             { elementId: "dp-alb",             x: 520,  y: 460  },
  
          // Subnet privada — lado direito da VPC
          "dp-private-subnet":  { elementId: "dp-private-subnet",  x: 800,  y: 180,  width: 700,  height: 720 },
  
          // ECS Cluster — topo da subnet privada
          // mgmt (col 1) e redir (col 2) lado a lado; worker abaixo no centro
          "dp-ecs-cluster":     { elementId: "dp-ecs-cluster",     x: 840,  y: 220,  width: 620,  height: 200 },
          "dp-ecs-mgmt":        { elementId: "dp-ecs-mgmt",        x: 880,  y: 280  },
          "dp-ecs-redir":       { elementId: "dp-ecs-redir",       x: 1140, y: 280  },
          "dp-ecs-worker":      { elementId: "dp-ecs-worker",      x: 1000, y: 460  },
  
          // RDS em AZs separadas — abaixo do ECS
          "dp-az-a":            { elementId: "dp-az-a",            x: 840,  y: 480,  width: 260,  height: 220 },
          "dp-az-b":            { elementId: "dp-az-b",            x: 1140, y: 480,  width: 260,  height: 220 },
          "dp-rds-primary":     { elementId: "dp-rds-primary",     x: 880,  y: 550  },
          "dp-rds-standby":     { elementId: "dp-rds-standby",     x: 1180, y: 550  },
  
          // ElastiCache — abaixo dos RDS
          "dp-elasticache":     { elementId: "dp-elasticache",     x: 1000, y: 760  },
  
          // Serviços gerenciados AWS — coluna direita da região (sem subnet)
          "dp-sqs":             { elementId: "dp-sqs",             x: 1420, y: 280  },
          "dp-cloudwatch":      { elementId: "dp-cloudwatch",      x: 1420, y: 520  },
          "dp-secrets":         { elementId: "dp-secrets",         x: 1420, y: 760  },
  
          // Nota Well-Architected — fora da região, à direita
          "dp-note-waf":        { elementId: "dp-note-waf",        x: 1680, y: 60,  width: 360, height: 600 },
        },
        snapshot: {
          iconLibrary: {},
          flows: {
