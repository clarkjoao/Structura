  ...
  return {
    ...
    "d-us-context": {
      ...
      nodeLayouts: {
        ...
        "us-ctx-note": {
          elementId: "us-ctx-note",
          x: 1239.1752577319585,
          y: 57.5257731958763,
          width: 360,
          height: 560,
        },
      ...
      snapshot: {
            ...
            steps: steps([
              {
                ...
                payload:
                  '{ "longUrl": "https://meu-site.com/artigo-muito-longo-2026", "customSlug": "artigo26" }',
              ...
              },
              {
                ...
                description:
                  "Sistema dispara e-mail de confirmação com a URL curta gerada via SendGrid.",
                isAsync: true,
              },
            ]),
          },
        ...
        connections: {
          "us-ctx-r1": {
            id: "us-ctx-r1",
            sourceId: "us-ctx-creator",
            targetId: "us-ctx-system",
            label: "Cria e gerencia links",
            technology: "HTTPS / JWT",
            intent: "call",
          },
          "us-ctx-r2": {
            id: "us-ctx-r2",
            sourceId: "us-ctx-visitor",
            targetId: "us-ctx-system",
            label: "Acessa link curto → redirect",
            technology: "HTTPS",
            intent: "call",
          },
          "us-ctx-r3": {
            id: "us-ctx-r3",
            sourceId: "us-ctx-system",
            targetId: "us-ctx-auth0",
          ...
          "us-ctx-r4": {
            id: "us-ctx-r4",
            sourceId: "us-ctx-system",
            targetId: "us-ctx-sendgrid",
            label: "Envia e-mails transacionais",
          ...
          "us-ctx-r5": {
            id: "us-ctx-r5",
            sourceId: "us-ctx-system",
            targetId: "us-ctx-maxmind",
            label: "Geolocaliza IPs de cliques",
            technology: "lib local / DB",
            intent: "call",
            style: { strokeStyle: StrokeStyle.Dashed },
          },
        },
    ...
    "d-us-containers": {
      ...
      nodeLayouts: {
        "us-ct-creator": {
          elementId: "us-ct-creator",
          x: -80.16393442622953,
          y: 175.08196721311478,
          width: 260,
          height: 85,
        },
        "us-ct-visitor": {
          elementId: "us-ct-visitor",
          x: -84.8360655737705,
          y: 520,
          width: 200,
          height: 68,
        ...
        "us-ct-boundary": {
          elementId: "us-ct-boundary",
          x: 250.57377049180326,
          y: 66.06557377049177,
          width: 1192,
          height: 836,
        },
        ...
        "us-ct-mgmt-api": {
          elementId: "us-ct-mgmt-api",
          x: 449.59016393442613,
          y: 38.28688524590163,
          width: 260,
          height: 155,
        },
        "us-ct-queue": {
          elementId: "us-ct-queue",
          x: 446.90163934426215,
          y: 650.9590163934427,
          width: 260,
          height: 109,
        },
        "us-ct-redir-api": {
          elementId: "us-ct-redir-api",
          x: 40,
          y: 473.6885245901639,
          width: 260,
          height: 109,
        ...
        "us-ct-db": {
          elementId: "us-ct-db",
          x: 891.7540983606555,
          y: 54.754098360655746,
          width: 260,
          height: 109,
        },
        "us-ct-worker": {
          elementId: "us-ct-worker",
          x: 849.0163934426228,
          y: 647.4590163934427,
          width: 260,
          height: 109,
        ...
        "us-ct-note": {
          elementId: "us-ct-note",
          x: 1479.0983606557375,
          y: 132.95081967213116,
          width: 340,
          height: 420,
        },
      },
      snapshot: {
        ...
        flows: {
            ...
            steps: steps([
              {
                ...
                description:
                  "Visitante clica no link curto. Browser envia GET /abc123 para a Redirect API.",
              },
              {
                id: "ct-r-f2",
                type: "action",
              ...
              },
              {
                ...
                componentId: "us-ct-redir-api",
                description:
                  "Redirect API responde HTTP 301 com Location: <url-longa>. Total < 50ms.",
                payload:
                  '{ "status": 301, "Location": "https://meu-site.com/artigo-muito-longo-2026" }',
                payloadDirection: "response",
              },
              {
                id: "ct-r-f5",
                ...
                description:
                  "Publica evento de clique na fila SQS de forma assíncrona (não bloqueia o redirect).",
                isAsync: true,
              },
              {
                id: "ct-r-f6",
                ...
                description:
                  "Analytics Worker consome o evento, faz lookup GeoIP e persiste métricas no banco.",
                isAsync: true,
              },
            ]),
          },
          ...
          // ═══════════════════════════════════════════════════════════════════
          // A leitura como depurador: pilha, contrato e estado acumulado.
          // ═══════════════════════════════════════════════════════════════════
          "flow-ct-create-stack": {
            id: "flow-ct-create-stack",
            name: "Criar link — pilha completa",
            diagramId: "d-us-containers",
            description:
              "A mesma criação, lida como um depurador: cada chamada abre uma pilha e só fecha quando a resposta volta.",
            ...
            steps: steps([
              {
                id: "ct-cs-1",
                type: "action",
                componentId: "us-ct-creator",
                connectionId: "us-ct-r1",
                title: "Criador envia a URL longa",
                description:
                  "O dashboard recebe a URL e o slug desejado e abre a primeira chamada.",
                payload:
                  '{ "longUrl": "https://meu-site.com/artigo-muito-longo-2026", "slug": "artigo26" }',
                payloadDirection: "request",
              ...
              },
              {
                id: "ct-cs-2",
                type: "action",
                componentId: "us-ct-spa",
                connectionId: "us-ct-r2",
                title: "SPA chama a Management API",
                description:
                  "Declara o corpo que espera de volta. A resposta lá embaixo não bate com ele — de propósito.",
                duration: "~120ms",
                payload: '{ "longUrl": "https://meu-site.com/...", "slug": "artigo26" }',
                payloadDirection: "request",
                context: {
                  reads: ["slug"],
                  expects: '{\n  "id": "u_9f2",\n  "slug": "artigo26",\n  "expiresAt": null\n}',
              ...
              },
              {
                id: "ct-cs-3",
                type: "action",
                componentId: "us-ct-mgmt-api",
                connectionId: "us-ct-r3",
                title: "INSERT na tabela urls",
                description:
                  "Terceiro nível da pilha: o rastro no rail mostra quem está esperando.",
                duration: "~18ms",
                payload: '{ "table": "urls", "slug": "artigo26" }',
                payloadDirection: "request",
              },
              {
                id: "ct-cs-4",
                type: "action",
                componentId: "us-ct-db",
                connectionId: "us-ct-r3",
                title: "1 linha gravada",
                description:
                  "A volta do banco. O id que ela traz sobrevive ao fim da chamada e entra no estado de quem chamou.",
                payload: '{ "rows": 1, "id": "u_9f2" }',
                payloadDirection: "response",
              ...
              },
              {
                ...
                type: "action",
                componentId: "us-ct-mgmt-api",
                connectionId: "us-ct-r4",
                title: "Aquece o cache",
                note: "O TTL vem da configuração do serviço e nenhum passo o registra. A leitura diz isso em vez de fingir que sabe.",
                description:
                  "Ninguém escreveu a resposta desta chamada — a leitura desenha a volta sozinha.",
                duration: "~3ms",
                payload: '{ "SETEX": "artigo26", "ttl": 86400 }',
                payloadDirection: "request",
                context: { reads: ["url_id", "ttl_horas"] },
              },
              {
                id: "ct-cs-6",
                type: "action",
                ...
                title: "201 Created",
                description:
                  "Traz uma chave a mais e uma a menos do que o passo 2 anunciou. A leitura compara e relata; nada é bloqueado.",
                payload:
                  '{ "id": "u_9f2", "slug": "artigo26", "createdAt": "2026-04-13T01:09:29Z" }',
                payloadDirection: "response",
              ...
              },
              {
                ...
                componentId: "us-ct-spa",
                connectionId: "us-ct-r1",
                title: "Dashboard mostra a URL curta",
                description: "Fecha a chamada mais externa: a pilha volta a zero.",
                payload: '{ "shortUrl": "https://url.sh/artigo26" }',
                payloadDirection: "response",
                // `slug` e não `short_url`: este passo fecha a chamada de fora,
                // e o que foi definido dentro dela sai de escopo junto com ela.
                context: { reads: ["slug"] },
              },
            ]),
          },
          ...
          "flow-ct-fanout": {
            id: "flow-ct-fanout",
            name: "Atualizar link — em paralelo",
            diagramId: "d-us-containers",
            description:
              "Renomear um slug dispara duas linhas que acontecem ao mesmo tempo, e uma delas ainda decide por onde vai.",
            ...
            steps: steps([
              {
                ...
                componentId: "us-ct-spa",
                connectionId: "us-ct-r2",
                title: "PATCH /api/urls/u_9f2",
                description: "O dashboard pede a troca do slug.",
                payload: '{ "slug": "artigo-2026" }',
                payloadDirection: "request",
                context: { sets: { link_id: "u_9f2", slug_novo: "artigo-2026" } },
                next: "ct-fo-par",
              },
              {
                id: "ct-fo-par",
                ...
                conditionKind: "par",
                branches: [
                  { label: "Notificações", nextId: "ct-fo-a1" },
                  { label: "Cache", nextId: "ct-fo-b1" },
                ],
              },
              {
                id: "ct-fo-a1",
                type: "action",
                componentId: "us-ct-mgmt-api",
                connectionId: "us-ct-r5",
                title: "Publica link.updated",
                description: "Dispara e segue: ninguém espera resposta desta.",
                payload: '{ "event": "link.updated", "id": "u_9f2" }',
                payloadDirection: "request",
                isAsync: true,
                context: { reads: ["link_id"] },
                next: "ct-fo-alt",
              },
              {
                id: "ct-fo-alt",
                type: "condition",
                componentId: "us-ct-queue",
                conditionLabel: "A fila tem consumidor ativo?",
                branches: [
                  { label: "Sim — entrega ao worker", nextId: "ct-fo-a2" },
                  { label: "Não — o evento fica retido", nextId: "ct-fo-join" },
                ],
              },
              {
                id: "ct-fo-a2",
                type: "action",
                componentId: "us-ct-queue",
                connectionId: "us-ct-r12",
                title: "Worker consome o evento",
                description:
                  "Uma decisão dentro de uma das linhas paralelas — bloco dentro de bloco.",
                isAsync: true,
                next: "ct-fo-join",
              },
              {
                ...
                componentId: "us-ct-mgmt-api",
                connectionId: "us-ct-r4",
                title: "Reaquece o cache com o slug novo",
                duration: "~3ms",
                payload: '{ "SETEX": "artigo-2026" }',
                payloadDirection: "request",
                context: { reads: ["slug_novo"] },
                next: "ct-fo-join",
              },
              {
                id: "ct-fo-join",
                ...
                connectionId: "us-ct-r2",
                title: "200 OK",
                description: "As duas linhas rodaram; a resposta fecha a chamada do dashboard.",
                payload: '{ "id": "u_9f2", "slug": "artigo-2026" }',
                payloadDirection: "response",
              },
            ]),
          },
          ...
          "flow-ct-batch": {
            ...
            diagramId: "d-us-containers",
            description:
              "O processamento em lote: um trecho que se repete, um que pode não acontecer, uma gravação crítica e um aborto.",
            tags: ["batch", "loop", "opcional"],
            mermaid: "sequenceDiagram",
            entryStepId: "ct-bt-1",
            // Escrito sem o encadeador: duas saídas terminam a leitura — o ack e
            // o aborto — e o helper só sabe não encadear a última da lista.
            steps: {
              "ct-bt-1": {
                id: "ct-bt-1",
                type: "action",
                componentId: "us-ct-queue",
                connectionId: "us-ct-r12",
                title: "Worker puxa o lote da fila",
                payload: '{ "batch": "2026-04-13", "pending": 1240 }',
                payloadDirection: "request",
                context: { sets: { lote: "2026-04-13", pendentes: "1240" } },
                next: "ct-bt-loop",
              },
              "ct-bt-loop": {
                id: "ct-bt-loop",
                ...
                branches: [{ label: "Processa 500 por vez", nextId: "ct-bt-l1" }],
              },
              "ct-bt-l1": {
                id: "ct-bt-l1",
                type: "action",
                componentId: "us-ct-worker",
                connectionId: "us-ct-r13",
                title: "INSERT das métricas agregadas",
                duration: "~90ms",
                payloadDirection: "request",
                payload: '{ "table": "url_clicks", "rows": 500 }',
                context: { reads: ["lote"] },
                next: "ct-bt-opt",
              },
              "ct-bt-opt": {
                ...
                componentId: "us-ct-worker",
                conditionKind: "opt",
                conditionLabel: "Há IPs ainda não geolocalizados?",
                branches: [
                  { label: "Consulta o GeoIP e enriquece", nextId: "ct-bt-o1" },
                  { label: "Segue sem enriquecer", nextId: "ct-bt-crit" },
                ],
              },
              "ct-bt-o1": {
                id: "ct-bt-o1",
                type: "action",
                componentId: "us-ct-worker",
                title: "Enriquece com país e dispositivo",
                context: { sets: { enriquecidos: "812" } },
                next: "ct-bt-crit",
              },
              "ct-bt-crit": {
                id: "ct-bt-crit",
                ...
                conditionLabel: "Gravação da transação",
                branches: [
                  { label: "Commit", nextId: "ct-bt-c1" },
                  { label: "Falha — rollback e recoloca na fila", nextId: "ct-bt-c2" },
                ],
              },
              "ct-bt-c1": {
                id: "ct-bt-c1",
              ...
              "ct-bt-c2": {
                ...
                type: "action",
                componentId: "us-ct-db",
                title: "ROLLBACK e recoloca o lote na fila",
                next: "ct-bt-break",
              },
              "ct-bt-break": {
                id: "ct-bt-break",
                ...
                branches: [
                  { label: "Aborta o lote e alerta o time", nextId: "ct-bt-b1" },
                  { label: "Segue e confirma o lote", nextId: "ct-bt-end" },
                ],
              },
              "ct-bt-b1": {
                id: "ct-bt-b1",
                type: "action",
                componentId: "us-ct-worker",
                title: "Registra a falha e para o processamento",
        ...
        connections: {
          "us-ct-r1": {
            id: "us-ct-r1",
            sourceId: "us-ct-creator",
            targetId: "us-ct-spa",
            label: "Gerencia links",
            technology: "HTTPS",
            intent: "call",
          },
          "us-ct-r2": {
          ...
          "us-ct-r3": {
            id: "us-ct-r3",
            sourceId: "us-ct-mgmt-api",
            targetId: "us-ct-db",
            label: "CRUD de URLs e usuários",
            technology: "SQL / TCP",
            intent: "data-flow",
            style: { strokeStyle: StrokeStyle.Solid, strokeWidth: 2 },
          },
          "us-ct-r4": {
            id: "us-ct-r4",
            sourceId: "us-ct-mgmt-api",
            targetId: "us-ct-cache",
            label: "Aquece cache (write-through)",
            technology: "Redis",
            intent: "call",
          },
          "us-ct-r5": {
            id: "us-ct-r5",
            sourceId: "us-ct-mgmt-api",
            targetId: "us-ct-queue",
            label: "Publica link.created",
            technology: "AWS SQS",
            intent: "event",
            style: { animated: true },
          },
          "us-ct-r6": {
            id: "us-ct-r6",
            sourceId: "us-ct-visitor",
            targetId: "us-ct-redir-api",
            label: "GET /{slug}",
            technology: "HTTPS",
            intent: "call",
          },
          "us-ct-r9": {
            id: "us-ct-r9",
            sourceId: "us-ct-redir-api",
            targetId: "us-ct-cache",
            label: "Lookup slug (< 2ms)",
            technology: "Redis",
            intent: "call",
          },
          "us-ct-r10": {
          ...
          "us-ct-r11": {
            ...
            sourceId: "us-ct-redir-api",
            targetId: "us-ct-queue",
            label: "Publica click.registered",
            technology: "AWS SQS",
            intent: "event",
            style: { animated: true },
          },
          "us-ct-r12": {
            id: "us-ct-r12",
            sourceId: "us-ct-queue",
            targetId: "us-ct-worker",
            label: "Consome eventos de clique",
            technology: "SQS polling",
            intent: "event",
            style: { animated: true },
          },
          "us-ct-r13": {
            id: "us-ct-r13",
            sourceId: "us-ct-worker",
            targetId: "us-ct-db",
            label: "Persiste métricas",
            technology: "SQL / TCP",
            intent: "data-flow",
          },
        },
    ...
    "d-us-components": {
      ...
      nodeLayouts: {
        "us-cp-lane-http": {
          elementId: "us-cp-lane-http",
          x: -492.96721311475403,
          y: -64.70491803278694,
          width: 909,
          height: 458,
        },
        "us-cp-lane-app": {
          elementId: "us-cp-lane-app",
          x: 460.0000000000002,
          y: -71.07377049180336,
          width: 1097,
          height: 530,
        ...
        "us-cp-lane-infra": {
          elementId: "us-cp-lane-infra",
          x: 1609.2295081967213,
          y: -73.7950819672132,
          width: 567,
          height: 934,
        },
        "us-cp-api-group": {
          elementId: "us-cp-api-group",
          x: 40,
          y: 70.3032786885246,
          width: 300,
          height: 308,
        ...
        "us-cp-cache-svc": {
          elementId: "us-cp-cache-svc",
          x: 796.5163934426228,
          y: 185.37704918032787,
          width: 260,
          height: 109,
        },
        "us-cp-event-pub": {
          elementId: "us-cp-event-pub",
          x: 416.7950819672127,
          y: 259.6065573770493,
          width: 260,
          height: 109,
        ...
        "us-cp-db-table-clicks": {
          elementId: "us-cp-db-table-clicks",
          x: 40,
          y: 634,
          width: 300,
          height: 220,
        ...
        "us-cp-json-create-req": {
          elementId: "us-cp-json-create-req",
          x: 247.13114754098365,
          y: 382.8360655737704,
          width: 280,
          height: 180,
        },
        "us-cp-json-create-res": {
          elementId: "us-cp-json-create-res",
          x: 235.7377049180327,
          y: 512.5327868852461,
          width: 280,
          height: 180,
      ...
      snapshot: {
            ...
            steps: steps([
              {
                ...
                payload:
                  '{ "longUrl": "https://meu-site.com/...", "customSlug": "artigo26", "expiresAt": null }',
                payloadDirection: "request",
              },
              {
                id: "cp-f2",
                ...
                description:
                  "AuthGuard valida o JWT com JWKS do Auth0 e injeta userId no contexto.",
                duration: "~40ms",
              },
              {
                id: "cp-f3",
                ...
                description:
                  "UrlService valida unicidade do slug, gera hash de 6 chars se não customizado, persiste na tabela urls.",
                duration: "~25ms",
              },
              {
                id: "cp-f4",
                ...
                description:
                  "CacheService grava slug → longUrl no Redis com TTL 24h (write-through).",
                duration: "~3ms",
              },
              {
                id: "cp-f5",
        ...
        components: {
          ...
          "us-cp-api-group": {
            ...
            type: "api-group",
            description:
              "Contrato REST completo da Management API. Todas as rotas exigem JWT Bearer.",
          ...
          "us-cp-ep-post": {
            ...
            type: "endpoint",
            description:
              "Cria uma nova URL curta. Valida unicidade do slug e retorna o link gerado.",
            parentId: "us-cp-api-group",
            method: "POST",
            path: "/urls",
            endpointDescription:
              "Body: { longUrl, customSlug?, expiresAt? }. Retorna 201 com shortUrl.",
            handlers: [
              {
                id: "h-post-1",
          ...
          "us-cp-ep-analytics": {
            ...
            endpointDescription:
              "Query params: ?from=&to=&groupBy=country|device|hour. Retorna séries temporais.",
            handlers: [],
          },
        ...
        connections: {
          "us-cp-conn-ep-guard": {
            id: "us-cp-conn-ep-guard",
            sourceId: "us-cp-ep-post",
            targetId: "us-cp-auth-guard",
            label: "valida JWT",
            intent: "call",
          },
          "us-cp-conn-guard-svc": {
            id: "us-cp-conn-guard-svc",
            sourceId: "us-cp-auth-guard",
            targetId: "us-cp-url-svc",
            label: "injeta contexto",
            intent: "call",
          },
          "us-cp-conn-svc-db": {
            id: "us-cp-conn-svc-db",
            sourceId: "us-cp-url-svc",
            targetId: "us-cp-db-table-urls",
            label: "INSERT / SELECT",
            intent: "data-flow",
            style: { strokeWidth: 2 },
          },
          "us-cp-conn-svc-cache": {
            id: "us-cp-conn-svc-cache",
            sourceId: "us-cp-url-svc",
            targetId: "us-cp-cache-svc",
            label: "write-through",
            intent: "call",
          },
          "us-cp-conn-svc-event": {
            id: "us-cp-conn-svc-event",
            sourceId: "us-cp-url-svc",
            targetId: "us-cp-event-pub",
            label: "link.created",
            intent: "event",
            style: { animated: true },
          },
          "us-cp-conn-anal-db": {
            id: "us-cp-conn-anal-db",
            sourceId: "us-cp-analytics-svc",
            targetId: "us-cp-db-table-clicks",
            label: "SELECT métricas",
            intent: "data-flow",
          },
          "us-cp-conn-ep-anal": {
            id: "us-cp-conn-ep-anal",
            sourceId: "us-cp-ep-analytics",
            targetId: "us-cp-analytics-svc",
            label: "consulta analytics",
            intent: "call",
          },
        },
      },
    ...
    "d-us-deployment": {
      ...
      scenes: {
        "scene-tobe-geodeploy": {
          ...
          nodeLayouts: {
            ...
            "dp-cloudfront": {
              elementId: "dp-cloudfront",
              x: 478.33814005262093,
              y: 251.25328880793364,
              width: 260,
              height: 109,
            },
            "dp-waf": {
            ...
            "dp-private-subnet": {
              elementId: "dp-private-subnet",
              x: 1368.8904008769234,
              y: 156.44443765209405,
              width: 1745,
              height: 887,
            },
            "dp-ecs-cluster": {
              elementId: "dp-ecs-cluster",
              x: 40,
              y: 206.58643770966995,
              width: 406,
              height: 600,
            },
            "dp-ecs-mgmt": {
              elementId: "dp-ecs-mgmt",
              x: 82.57105598773478,
              y: 426.57055396056455,
              width: 260,
              height: 109,
            },
            "dp-ecs-redir": {
              elementId: "dp-ecs-redir",
              x: 68.27253473588007,
              y: 82.57105598773467,
              width: 260,
              height: 109,
            ...
            "dp-ecs-worker": {
              elementId: "dp-ecs-worker",
              x: 51.57014206152553,
              y: 236.52936334325125,
              width: 260,
              height: 109,
            },
            "dp-az-a": {
            ...
            "dp-az-b": {
              elementId: "dp-az-b",
              x: 1364.8882383482553,
              y: 41.406937615188326,
              width: 340,
              height: 229,
            },
            "dp-rds-primary": {
              elementId: "dp-rds-primary",
              x: 43.85802469135797,
              y: 92.08333333333337,
              width: 260,
              height: 109,
            ...
            "dp-rds-standby": {
              elementId: "dp-rds-standby",
              x: 53.503086419753345,
              y: 101.7283950617284,
              width: 260,
              height: 109,
            },
            "dp-elasticache": {
              elementId: "dp-elasticache",
              x: 1371.1362571476986,
              y: 629.1346524769581,
              width: 260,
              height: 109,
            },
            "dp-sqs": {
              elementId: "dp-sqs",
              x: 3143.3798739451267,
              y: 687.2505117930084,
              width: 260,
              height: 109,
            },
            "dp-cloudwatch": {
              elementId: "dp-cloudwatch",
              x: 3141.590222898914,
              y: 383.7096931554442,
              width: 260,
              height: 109,
            ...
            "dp-secrets": {
              elementId: "dp-secrets",
              x: 3147.7493803453135,
              y: 539.4562280975456,
              width: 260,
              height: 109,
            },
            "dp-note-waf": {
              elementId: "dp-note-waf",
              x: 2105.9153005464486,
              y: -567.3787568306011,
              width: 360,
              height: 600,
            },
      ...
      nodeLayouts: {
        ...
        "dp-lambda-edge": {
          elementId: "dp-lambda-edge",
          x: 498.33814005262093,
          y: 360.25328880793364,
          width: 260,
          height: 109,
        },
      ...
      snapshot: {
            ...
            steps: steps([
              {
                ...
                description:
                  "Route53 resolve o DNS de url.sh para o IP do CloudFront distribution.",
              ...
              },
              {
                ...
                description:
                  "CloudFront verifica cache. Miss para /slug → WAF inspeciona o request.",
                duration: "~5ms",
              },
              {
                id: "dp-f3",
                ...
                componentId: "dp-waf",
                description:
                  "WAF aplica regras: rate limit por IP (1000 req/min), bloqueia padrões maliciosos.",
                duration: "~2ms",
              },
              {
                id: "dp-f4",
              ...
              },
              {
                ...
                description:
                  "Publica evento click.registered no SQS de forma assíncrona. HTTP 301 já foi enviado.",
                isAsync: true,
              },
              {
                id: "dp-f7",
                ...
                description:
                  "SQS entrega mensagem ao Analytics Worker. Worker persiste no RDS e atualiza CloudWatch.",
                isAsync: true,
              },
            ]),
          },
        ...
        components: {
          ...
          "dp-region": {
            ...
            type: "panel",
            description:
              "Região AWS principal. Multi-AZ para RDS. CloudFront com edge locations globais.",
            parentId: null,
            panelKind: PanelKind.Default,
          },
          "dp-vpc": {
          ...
          "dp-ecs-cluster": {
            ...
            type: "panel",
            description:
              "Cluster ECS Fargate. Sem instâncias EC2 para gerenciar. Container Insights habilitado.",
        ...
        connections: {
          ...
          "dp-r-cf-s3": {
            ...
            sourceId: "dp-cloudfront",
            targetId: "dp-s3-spa",
            label: "serve SPA estático",
            technology: "S3 Origin",
            intent: "call",
          },
          "dp-r-cf-waf": {
            id: "dp-r-cf-waf",
          ...
          "dp-r-alb-mgmt": {
            id: "dp-r-alb-mgmt",
            sourceId: "dp-alb",
            targetId: "dp-ecs-mgmt",
            label: "roteia /api/*",
            technology: "HTTP :3000",
            intent: "call",
          },
          "dp-r-alb-redir": {
            id: "dp-r-alb-redir",
            sourceId: "dp-alb",
            targetId: "dp-ecs-redir",
            label: "roteia /{slug}",
          ...
          "dp-r-redir-cache": {
            id: "dp-r-redir-cache",
            sourceId: "dp-ecs-redir",
            targetId: "dp-elasticache",
            label: "GET slug (< 2ms)",
          ...
          "dp-r-worker-rds": {
            id: "dp-r-worker-rds",
            sourceId: "dp-ecs-worker",
            targetId: "dp-rds-primary",
            label: "INSERT métricas",
            technology: "TCP :5432",
            intent: "data-flow",
          },
          "dp-r-rds-standby": {
            id: "dp-r-rds-standby",
            sourceId: "dp-rds-primary",
            targetId: "dp-rds-standby",
            label: "replicação síncrona",
            technology: "Multi-AZ sync",
            intent: "data-flow",
            style: { strokeWidth: 2 },
          },
          "dp-r-ecs-cw": {
            id: "dp-r-ecs-cw",
            sourceId: "dp-ecs-redir",
            targetId: "dp-cloudwatch",
            label: "métricas e logs",
