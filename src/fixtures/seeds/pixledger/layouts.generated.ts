...
export const SEED_PL_LAID_OUT: Record<string, SeedLaidOutSlice> = {
  "d-pl-context": {
    ...
    handleOrder: {
      ...
      "pl-ctx-hub": {
        outgoing: ["pl-ctx-r5", "pl-ctx-r4", "pl-ctx-r3"],
        incoming: ["pl-ctx-r1", "pl-ctx-r8"],
      },
      "pl-ctx-ledger": {
        outgoing: ["pl-ctx-r11", "pl-ctx-r6"],
        incoming: ["pl-ctx-r3", "pl-ctx-r9"],
      },
      "pl-ctx-risk": {
        outgoing: ["pl-ctx-r7"],
        incoming: ["pl-ctx-r5", "pl-ctx-r11"],
      },
      "pl-ctx-platform": {
        outgoing: ["pl-ctx-r8", "pl-ctx-r10", "pl-ctx-r9"],
        incoming: ["pl-ctx-r2"],
      },
      "pl-ctx-spi": {
        outgoing: [],
  ...
  "d-pl-ct-hub": {
    ...
    handleOrder: {
      "pl-hub-payer": {
        outgoing: ["pl-hub-c-payer"],
        incoming: [],
      },
      "pl-hub-merchant-sys": {
        outgoing: ["pl-hub-c-merchant-wh", "pl-hub-c-merchant"],
        incoming: [],
      },
      "pl-hub-cob-api": {
        outgoing: ["pl-hub-c-cob-cache", "pl-hub-c-dict"],
        incoming: ["pl-hub-c-svc-api", "pl-hub-c-merchant"],
      },
      "pl-hub-dict": {
        outgoing: ["pl-hub-c-dict-spi"],
        incoming: ["pl-hub-c-dict"],
      },
      "pl-hub-webhook": {
        outgoing: ["pl-hub-c-queue", "pl-hub-c-cache", "pl-hub-c-risk"],
        incoming: ["pl-hub-c-merchant-wh", "pl-hub-c-spi"],
      },
      "pl-hub-cache": {
        outgoing: [],
        incoming: ["pl-hub-c-cache", "pl-hub-c-cache-redis", "pl-hub-c-cob-cache"],
      },
      "pl-hub-queue": {
        outgoing: [],
        incoming: ["pl-hub-c-pub-queue", "pl-hub-c-worker", "pl-hub-c-queue"],
      },
      "pl-hub-worker": {
        outgoing: ["pl-hub-c-ledger", "pl-hub-c-worker", "pl-hub-c-worker-risk"],
        incoming: [],
      },
      "pl-hub-spi": {
        outgoing: ["pl-hub-c-spi"],
        incoming: ["pl-hub-c-payer", "pl-hub-c-dict-spi"],
      },
      "pl-hub-risk-ext": {
        outgoing: [],
        incoming: ["pl-hub-c-worker-risk", "pl-hub-c-risk"],
      },
      "pl-hub-ledger-ext": {
        outgoing: [],
        incoming: ["pl-hub-c-ledger"],
      },
      "pl-hub-ep-post": {
        outgoing: ["pl-hub-c-ep-guard"],
        incoming: [],
      },
      "pl-hub-auth-guard": {
        outgoing: ["pl-hub-c-guard-svc"],
        incoming: ["pl-hub-c-ep-guard"],
      },
      "pl-hub-cob-svc": {
        outgoing: ["pl-hub-c-svc-pub", "pl-hub-c-svc-cache", "pl-hub-c-svc-api"],
        incoming: ["pl-hub-c-guard-svc"],
      },
      "pl-hub-cache-svc": {
        outgoing: ["pl-hub-c-cache-redis"],
        incoming: ["pl-hub-c-svc-cache"],
      },
      "pl-hub-event-pub": {
        outgoing: ["pl-hub-c-pub-queue"],
        incoming: ["pl-hub-c-svc-pub"],
      },
    },
  },
  "d-pl-ct-ledger": {
    ...
    handleOrder: {
      ...
      "pl-led-settlement": {
        outgoing: ["pl-led-c5", "pl-led-c6", "pl-led-c4"],
        incoming: [],
      },
      "pl-led-kafka": {
        outgoing: [],
        incoming: ["pl-led-c4", "pl-led-c3"],
      },
      "pl-led-bank": {
        outgoing: [],
        incoming: ["pl-led-c5"],
  ...
  "d-pl-ct-risk": {
    ...
    handleOrder: {
      ...
      "pl-risk-engine": {
        outgoing: ["pl-risk-c5", "pl-risk-c4", "pl-risk-c6"],
        incoming: ["pl-risk-c3"],
      },
      "pl-risk-rules": {
        outgoing: [],
      ...
      "pl-risk-api": {
        outgoing: ["pl-risk-c3"],
        incoming: ["pl-risk-c2", "pl-risk-c1"],
      },
      "pl-risk-kyc": {
        outgoing: [],
        incoming: ["pl-risk-c6"],
  ...
  "d-pl-ct-merchant": {
    ...
    handleOrder: {
      ...
      "pl-mer-api": {
        outgoing: ["pl-mer-c6", "pl-mer-c5", "pl-mer-c7", "pl-mer-c3", "pl-mer-c4"],
        incoming: ["pl-mer-c2"],
      },
      "pl-mer-webhooks": {
        outgoing: [],
  ...
  "d-pl-dp-ledger": {
    ...
    handleOrder: {
      "pl-dpl-ecs": {
        outgoing: ["pl-dpl-c1", "pl-dpl-c2"],
        incoming: [],
      },
      "pl-dpl-settle": {
        outgoing: ["pl-dpl-c3", "pl-dpl-c5", "pl-dpl-c4"],
        incoming: [],
      },
      "pl-dpl-aurora": {
        outgoing: [],
  ...
  "d-pl-dp-risk": {
    ...
    handleOrder: {
      ...
      "pl-dpr-deploy": {
        outgoing: ["pl-dpr-c6", "pl-dpr-c4", "pl-dpr-c5", "pl-dpr-c7"],
        incoming: ["pl-dpr-c3"],
      },
      "pl-dpr-api-deploy": {
        outgoing: ["pl-dpr-c3"],
  ...
  "d-pl-dp-merchant": {
    ...
    handleOrder: {
      ...
      "pl-dpm-ecs": {
        outgoing: ["pl-dpm-c5", "pl-dpm-c3", "pl-dpm-c4"],
        incoming: ["pl-dpm-c2"],
      },
      "pl-dpm-wh": {
        outgoing: ["pl-dpm-c6"],
