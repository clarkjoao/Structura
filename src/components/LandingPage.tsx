...
function HeroGraph({
  ...
  return (
    <div className="relative w-full h-full grid-pattern-dense rounded-xl border border-border overflow-hidden">
      ...
      <C4Node label={labels.user} type="person" x={44} y={5} delay={0.3} />
      <C4Node label={labels.apiGateway} type="system" x={15} y={35} delay={0.5} />
      <C4Node label={labels.webApp} type="system" x={65} y={35} delay={0.6} />
      <C4Node label={labels.authService} type="container" x={8} y={65} delay={0.7} />
      <C4Node label={labels.orderService} type="container" x={33} y={65} delay={0.8} />
      <C4Node label={labels.database} type="component" x={60} y={65} delay={0.9} />
...
const LandingPage = () => {
  ...
  const heroLabels = useMemo(
    () => ({
      user: t("landing.heroNodeUser"),
      apiGateway: t("landing.heroNodeApiGateway"),
      webApp: t("landing.heroNodeWebApp"),
      authService: t("landing.heroNodeAuth"),
      orderService: t("landing.heroNodeOrder"),
      database: t("landing.heroNodeDatabase"),
    }),
    [t],
  );
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <HeroGraph labels={heroLabels} draftLabel={t("landing.draftLabel")} />
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          >
            <h2 className="text-3xl font-bold mb-4">
              ...
              <span className="text-primary">{t("landing.featuresSectionAccent")}</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              {t("landing.featuresSectionLead")}
            </p>
          </motion.div>
