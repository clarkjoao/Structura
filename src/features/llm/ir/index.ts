export type { DiagramIR, IRDiagramType, IREdge, IRNode, SemanticType, Tier } from "./ir.types";
export {
...
export { isBoundarySemanticType, mapSemanticTypeToComponent } from "./ir-to-component";
