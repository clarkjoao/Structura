...
import { apiGroupElement } from "./api-group.element";
import { endpointElement } from "./endpoint.element";
import type { NodeBuildContext } from "@/features/canvas/nodes/node-types/types";

// The two descriptors moved onto the element registry; what they promise about
// which scripts a route offers did not, so this file moved with them.
const endpointDescriptor = endpointElement.canvas;
const apiGroupDescriptor = apiGroupElement.canvas;
