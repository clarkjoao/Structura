...
import type { Component, C4Component, PanelComponent, NoteComponent, AwsComponent, EndpointComponent } from "./component.types";
...
export const isEndpointComponent = (c: Component): c is EndpointComponent => c.type === "endpoint";
