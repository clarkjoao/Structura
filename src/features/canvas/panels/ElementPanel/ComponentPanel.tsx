                  ...
                  <select
                    ...
                    onChange={(event) => {
                      ...
                      updateComponent(component.id, {
                        type: nextType,
                        awsService:
                          nextProvider?.id === "aws" && cloudService ? cloudService : undefined,
                        gcpService:
                          nextProvider?.id === "gcp" && cloudService ? cloudService : undefined,
                        azureService:
                          nextProvider?.id === "azure" && cloudService ? cloudService : undefined,
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(event) => {
                      ...
                      updateComponent(component.id, {
                        awsService:
                          cloudProvider.id === "aws" ? nextService || undefined : undefined,
                        gcpService:
                          cloudProvider.id === "gcp" ? nextService || undefined : undefined,
                        azureService:
                          cloudProvider.id === "azure" ? nextService || undefined : undefined,
