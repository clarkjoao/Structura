...
const JsonViewerNode = memo(
  ({ data: diagramNodeData, selected }: NodeProps<Node<JsonViewerNodeData>>) => {
    ...
    const handleStartEdit = useCallback(() => {
      ...
      setMode("editing");
    }, [mode, expandToEditingLayout, diagramNodeData.jsonContent, onInlineEditingChange]);
