...
- [x] 5.2 Pin a key and walk the whole reading; verify by screenshot that it survives the frame closing as _out of scope_ and that its life names the steps that introduced, read and ended it.
...
- [x] 6.11 Read the seeded script in the running editor; verify by screenshot that the object reads as one object with the marks, that the panel says _ao fim do roteiro_ with no step selected and _no passo 2_ with one, and that taking a key over and giving it back both work.
